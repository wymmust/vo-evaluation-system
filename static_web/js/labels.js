...
export const LABELS = {
  ...
  error_local_path_no_server: "当前页面不是通过 static_web/local_server.py 启动，不能直接读取本地路径。请在仓库根目录运行 python static_web/local_server.py --host 127.0.0.1 --port 8766 后打开 http://127.0.0.1:8766/，或者改用目录选择按钮导入文件。",
